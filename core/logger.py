...
class VisualWriter():
    ...
    #Changed here! added min_val and max_val as args
    def save_images(self, results, min_val=None, max_val=None, scaleFactor = None):
        ...
        try:
            names = results['name']
            #Changed here! added min_val and max_val as args
            outputs = Util.postprocess(results['result'], out_type=self.out_type, scale_factor=self.scale_factor, min_val=min_val, max_val=max_val, scaleFactor = scaleFactor)
